...
--------------------------------------------------------------------------------
modifier_lu_bu_god_strike_arc = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_lu_bu_god_strike_arc:IsHidden()
	return true
end

function modifier_lu_bu_god_strike_arc:IsDebuff()
	return false
end

function modifier_lu_bu_god_strike_arc:IsStunDebuff()
	return false
end

function modifier_lu_bu_god_strike_arc:IsPurgable()
	return true
end

function modifier_lu_bu_god_strike_arc:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_lu_bu_god_strike_arc:OnCreated( kv )
...
function modifier_lu_bu_god_strike_arc:OnRefresh( kv )
	self:OnCreated( kv )
end

function modifier_lu_bu_god_strike_arc:OnRemoved()
end

function modifier_lu_bu_god_strike_arc:OnDestroy()
	if not IsServer() then return end
...
--------------------------------------------------------------------------------
-- Modifier Effects
function modifier_lu_bu_god_strike_arc:DeclareFunctions()
	local funcs = {
...
function modifier_lu_bu_god_strike_arc:GetModifierDisableTurning()
	if not self.isForward then return end
	return 1
end
function modifier_lu_bu_god_strike_arc:GetOverrideAnimation()
	return self:GetStackCount()
end
--------------------------------------------------------------------------------
-- Status Effects
function modifier_lu_bu_god_strike_arc:CheckState()
	local state = {
...
--------------------------------------------------------------------------------
-- Motion Effects
function modifier_lu_bu_god_strike_arc:UpdateHorizontalMotion( me, dt )
...
function modifier_lu_bu_god_strike_arc:UpdateVerticalMotion( me, dt )
	if self.fix_duration and self:GetElapsedTime()>=self.duration then return end
...
function modifier_lu_bu_god_strike_arc:OnHorizontalMotionInterrupted()
	self.interrupted = true
	self:Destroy()
end

function modifier_lu_bu_god_strike_arc:OnVerticalMotionInterrupted()
	self.interrupted = true
	self:Destroy()
end
...
--------------------------------------------------------------------------------
-- Motion Helper
function modifier_lu_bu_god_strike_arc:SetJumpParameters( kv )
...
function modifier_lu_bu_god_strike_arc:Jump()
...
function modifier_lu_bu_god_strike_arc:InitVerticalArc( height_start, height_max, height_end, duration )
...
function modifier_lu_bu_god_strike_arc:GetVerticalPos( time )
	return self.const1*time - self.const2*time*time
end

function modifier_lu_bu_god_strike_arc:GetVerticalSpeed( time )
	return self.const1 - 2*self.const2*time
end

--------------------------------------------------------------------------------
-- Helper
function modifier_lu_bu_god_strike_arc:SetEndCallback( func )
