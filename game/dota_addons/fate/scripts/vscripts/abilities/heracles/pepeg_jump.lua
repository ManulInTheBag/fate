    ...
    if not self.do_damage then
        ...
        for _,enemy in ipairs(enemies) do
            if enemy ~= self.parent then 
                ...
                DoDamage(self.caster, enemy, self.percent_damage, DAMAGE_TYPE_MAGICAL, 0, self:GetAbility(), false)
        ...
        if (self.parent:GetTeamNumber() ~= self.caster:GetTeamNumber()) then
            ...
            DoDamage(self.caster, self.parent, self.percent_damage, DAMAGE_TYPE_MAGICAL, 0, self:GetAbility(), false)
