...
HeroSelection.prototype.Render = function() {
    ...
    var playerHasPicked = !!this.picked[this.playerId];
	    ...
	    var easyheroclass = new Array("npc_dota_hero_spectre","npc_dota_hero_abaddon","npc_dota_hero_queenofpain",
		"npc_dota_hero_mirana"
		,"npc_dota_hero_legion_commander","npc_dota_hero_phantom_lancer","npc_dota_hero_omniknight","npc_dota_hero_beastmaster");
    var normalheroclass = new Array("npc_dota_hero_drow_ranger","npc_dota_hero_skywrath_mage",
	"npc_dota_hero_ember_spirit","npc_dota_hero_doom_bringer","npc_dota_hero_bounty_hunter",
	"npc_dota_hero_huskar","npc_dota_hero_lina","npc_dota_hero_dark_willow","npc_dota_hero_tidehunter","npc_dota_hero_riki","npc_dota_hero_bloodseeker","npc_dota_hero_templar_assassin"
	,"npc_dota_hero_chen","npc_dota_hero_naga_siren","npc_dota_hero_ursa");
    var hardheroclass = new Array("npc_dota_hero_crystal_maiden","npc_dota_hero_shadow_shaman","npc_dota_hero_juggernaut","npc_dota_hero_vengefulspirit"
	,"npc_dota_hero_windrunner","npc_dota_hero_sven","npc_dota_hero_enchantress", "npc_dota_hero_skeleton_king");
 ...
 var randomPanel = this.hardheroesPanel.FindChild("random");
    if (randomPanel == null) {
        randomPanel = $.CreatePanel("Image",this.hardheroesPanel,"random");
