...
require("abilities/general/legacy_shared")
...
function Precache( context )
	...
	-- [rasputin] модель, звуки и партиклы кита (папкой: часть путей собирается в рантайме конкатенацией "_bk")
	PrecacheResource("model", "models/rasputin/kirei_1.vmdl", context)
	PrecacheResource("model", "models/rasputin/keys/keys.vmdl", context)
	PrecacheResource("soundfile", "soundevents/hero_rasputin.vsndevts", context)
	...
	PrecacheResource("particle", "particles/econ/items/axe/axe_cinder/axe_cinder_battle_hunger_start.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_bristleback/bristleback_warpath.vpcf", context)
	PrecacheResource("soundfile", "soundevents/game_sounds_heroes/game_sounds_lich.vsndevts", context)
	PrecacheResource("particle", "particles/tamamo/tamamo_mantra_wind_warp.vpcf", context)
	PrecacheResource("particle", "particles/tamamo/tamamo_mantra_void_warp.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_templar_assassin/templar_assassin_refraction_break.vpcf", context)
	PrecacheResource("particle", "particles/tamamo/tamamo_mantra_ice_warp.vpcf", context)
	PrecacheResource("particle", "particles/tamamo/tamamo_mantra_fire_warp.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_oracle/oracle_purifyingflames_halo.vpcf", context)
	PrecacheResource("particle", "particles/custom/tamamo/tamamo_mantra.vpcf", context)
	...
	PrecacheResource("particle", "particles/units/heroes/hero_axe/axe_counterhelix_unused.vpcf", context)
	PrecacheResource("particle", "particles/custom/false_assassin/fa_tsubame_gaeshi_first_slash.vpcf", context)
	PrecacheResource("particle", "particles/custom/false_assassin/fa_tsubame_gaeshi_second_slash.vpcf", context)
	PrecacheResource("particle", "particles/custom/false_assassin/fa_tsubame_gaeshi_third_slash.vpcf", context)
	PrecacheResource("particle", "particles/custom/false_assassin/tsubame_gaeshi/tsubame_gaeshi_windup_indicator.vpcf", context)
	PrecacheResource("particle", "particles/custom/astolfo/astolfo_down_with_a_touch_projectile.vpcf", context)
	PrecacheResource("soundfile", "soundevents/game_sounds_heroes/game_sounds_sniper.vsndevts", context)
	PrecacheResource("particle", "particles/custom/berserker/nine_lives/hit.vpcf", context)
	PrecacheResource("particle", "particles/custom/berserker/nine_lives/last_hit.vpcf", context)
	...
	PrecacheResource("particle", "particles/econ/items/earthshaker/egteam_set/hero_earthshaker_egset/earthshaker_echoslam_start_magma_cracks_egset.vpcf", context)
	...
	PrecacheResource("particle", "particles/custom/ta/zabaniya_fiendsgrip_hands_combo.vpcf", context)
	PrecacheResource("particle", "particles/custom/ta/zabaniya_ulti_smoke.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_phantom_assassin/phantom_assassin_stifling_dagger.vpcf", context)
	PrecacheResource("particle", "particles/custom/tamamo/charms_blue_explosion.vpcf", context)
	PrecacheResource("particle", "particles/custom/tamamo/charms_blue.vpcf", context)
	PrecacheResource("particle", "particles/custom/tamamo/charms_red_explosion.vpcf", context)
	PrecacheResource("particle", "particles/custom/tamamo/charms_red.vpcf", context)
	PrecacheResource("particle", "particles/custom/tamamo/charms_green_explosion.vpcf", context)
	PrecacheResource("particle", "particles/custom/tamamo/charms_green.vpcf", context)
	PrecacheResource("particle", "particles/custom/tamamo/charms_purple_explosion.vpcf", context)
	PrecacheResource("particle", "particles/custom/tamamo/charms_purle.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_crystalmaiden/maiden_crystal_nova.vpcf", context)
	PrecacheResource("particle", "particles/tamamo/tamamo_lightning.vpcf", context)
	PrecacheResource("particle", "particles/tamamo/tamamo_void_warp.vpcf", context)
	PrecacheResource("particle", "particles/custom/tamamo/tamamo_kick_trail.vpcf", context)
	PrecacheResource("particle", "particles/custom/screen_violet_splash.vpcf", context)
	...
	PrecacheResource("particle", "particles/custom/saber/strike_air_upstream/strike_air_upstream.vpcf", context)
	PrecacheResource("particle", "particles/custom/saber_strike_air_blast.vpcf", context)
	...
	PrecacheResource("particle", "particles/custom/saber_avalon_floor.vpcf", context)
	PrecacheResource("particle", "particles/custom/saber_avalon_impact.vpcf", context)
	PrecacheResource("particle", "particles/custom/saber_avalon_explosion.vpcf", context)
	PrecacheResource("particle", "particles/custom/rider/rider_nail_swing.vpcf", context)
	PrecacheResource("particle", "particles/custom/rider/rider_mystic_eye_debuff.vpcf", context)
	PrecacheResource("particle", "particles/custom/rider/rider_bellerophon_2_beam_charge.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_invoker/invoker_emp_charge.vpcf", context)
	PrecacheResource("particle", "particles/items_fx/dust_of_appearance_true_sight.vpcf", context)
	PrecacheResource("particle", "particles/custom/rider/rider_bellerophon_1.vpcf", context)
	PrecacheResource("particle", "particles/custom/rider/rider_bellerophon_1_alternate.vpcf", context)
	PrecacheResource("particle", "particles/custom/rider/rider_bellerophon_1_impact.vpcf", context)
	PrecacheResource("particle", "particles/zlodemon/medusa/medusa_trail_ult.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_tusk/tusk_ice_shards_projectile.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_winter_wyvern/wyvern_cold_embrace_buff_model.vpcf", context)
	PrecacheResource("particle", "particles/econ/items/wraith_king/wraith_king_ti6_bracer/wraith_king_ti6_witness_ambient_body.vpcf", context)
	PrecacheResource("particle", "soundevents/game_sounds_heroes/game_sounds_abaddon.vsndevts", context)
	PrecacheResource("particle", "particles/custom/screen_lightblue_splash.vpcf", context)
	PrecacheResource("soundfile", "soundevents/game_sounds_heroes/game_sounds_wisp.vsndevts", context)
	PrecacheResource("particle", "particles/custom/archer/archer_clairvoyance_dust.vpcf", context)
	PrecacheResource("particle", "particles/custom/archer/archer_clairvoyance_circle.vpcf", context)
	PrecacheResource("soundfile", "soundevents/game_sounds_heroes/game_sounds_keeper_of_the_light.vsndevts", context)
	PrecacheResource("particle", "particles/custom/lishuwen/lishuwen_no_second_strike_hit.vpcf", context)
	...
	PrecacheResource("particle", "particles/custom/lishuwen/lishuwen_first_hit.vpcf", context)
	PrecacheResource("particle", "particles/custom/lishuwen/lishuwen_second_hit.vpcf", context)
	PrecacheResource("particle", "particles/custom/lishuwen/lishuwen_third_hit.vpcf", context)
	...
	PrecacheResource("particle", "particles/items2_fx/shadow_amulet_activate_end_flash.vpcf", context)
	PrecacheResource("particle", "particles/econ/items/morphling/morphling_crown_of_tears/morphling_crown_ambient_trail.vpcf", context)
	PrecacheResource("particle", "particles/custom/lancer/lancer_relentless_spear/lancer_relentless_spear.vpcf", context)
	PrecacheResource("particle", "particles/custom/lancelot/lancelot_arondite.vpcf", context)
	...
	PrecacheResource("model", "models/lancelot/lancelot_f16.vmdl", context)
	PrecacheResource("particle", "particles/custom/archer/archer_sword_barrage_impact_circle.vpcf", context)
	PrecacheResource("particle", "particles/custom/lancelot/lancelot_nuke_impact_circle.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_gyrocopter/gyro_calldown_explosion_second.vpcf", context)
	PrecacheResource("particle", "particles/econ/items/gyrocopter/hero_gyrocopter_gyrotechnics/gyro_calldown_first.vpcf", context)
	PrecacheResource("particle", "particles/custom/lancelot/lancelot_nuke_calldown_marker_c.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_lina/lina_spell_light_strike_array_explosion.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_lina/lina_spell_light_strike_array_impact_sparks.vpcf", context)
	PrecacheResource("particle", "particles/items_fx/black_king_bar_avatar.vpcf", context)
	PrecacheResource("particle", "particles/custom/kinghassan/ka_spin.vpcf", context)
	PrecacheResource("particle", "particles/kinghassan/combo/comboaura.vpcf", context)
	PrecacheResource("particle", "particles/econ/events/new_bloom/pig_death_pop.vpcf", context)
	PrecacheResource("particle", "particles/kinghassan/combo/comboareadarknew.vpcf", context)
	PrecacheResource("particle", "particles/kinghassan/combo/comboslashfromult.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_undying/undying_soul_rip_damage_impact_secondary.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_axe/axe_culling_blade_kill.vpcf", context)
	PrecacheResource("particle", "particles/econ/items/axe/ti9_jungle_axe/ti9_jungle_axe_culling_blade_boost_streak.vpcf", context)
	PrecacheResource("particle", "particles/econ/items/axe/ti9_jungle_axe/ti9_jungle_axe_culling_blade_cast_arc.vpcf", context)
	PrecacheResource("particle", "particles/econ/items/dragon_knight/dk_immortal_dragon/dragon_knight_dragon_tail_embers_iron_dragon.vpcf", context)
	PrecacheResource("particle", "particles/econ/items/elder_titan/elder_titan_2021/elder_titan_2021_earth_splitter_ground_crack_noise.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_nevermore/nevermore_shadowraze_end_smoke.vpcf", context)
	PrecacheResource("particle", "particles/custom/iskandar/iskandar_combo_invul.vpcf", context)
	PrecacheResource("particle", "particles/custom/iskandar/iskandar_combo_arrow.vpcf", context)
	PrecacheResource("particle", "particles/custom/iskandar/iskandar_combo_mute.vpcf", context)
	...
	PrecacheResource("particle", "particles/units/heroes/hero_witchdoctor/witchdoctor_maledict_dot.vpcf", context)
	...
	PrecacheResource("model", "models/props_structures/skeleton001.vmdl", context)
	...
	PrecacheResource("particle", "particles/units/heroes/hero_phoenix/phoenix_supernova_reborn_shockwave.vpcf", context)
	...
	PrecacheResource("particle", "particles/units/heroes/hero_tidehunter/tidehunter_spell_ravage_hit_wrap.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_tidehunter/tidehunter_spell_ravage_hit.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_oracle/oracle_purifyingflames_heal.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_warlock/warlock_rain_of_chaos_start.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_warlock/warlock_death_glyph.vpcf", context)
	...
	PrecacheResource("particle", "particles/econ/items/enigma/enigma_world_chasm/enigma_blackhole_ti5_dark_swirl.vpcf", context)
	...
	PrecacheResource("particle", "particles/heroes/saito/saito_mind_eye_linken_release.vpcf", context)
	PrecacheResource("particle", "particles/custom/false_assassin/fa_thunder_clap.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_razor/razor_ambient_g.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_brewmaster/brewmaster_primal_split_storm_image.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_zuus/zuus_thundergods_wrath_start_f.vpcf", context)
	...
	PrecacheResource("particle", "particles/items2_fx/urn_of_shadows_heal_c.vpcf", context)
	...
	PrecacheResource("particle", "particles/custom/caster/workshop_explosion.vpcf", context)
	PrecacheResource("particle", "particles/custom/caster/caster_recall_out.vpcf", context)
	...
	PrecacheResource("particle", "particles/custom/berserker/fissure_strike/shockwave.vpcf", context)
	PrecacheResource("soundfile", "soundevents/game_sounds_heroes/game_sounds_magnataur.vsndevts", context)
	PrecacheResource("soundfile", "soundevents/game_sounds_heroes/game_sounds_axe.vsndevts", context)
	PrecacheResource("particle", "particles/custom/berserker/courage/buff.vpcf", context)
	PrecacheResource("particle", "particles/custom/berserker/courage/debuff.vpcf", context)
	PrecacheResource("particle", "particles/custom/berserker/courage/stun_explosion.vpcf", context)
	PrecacheResource("particle", "particles/custom/avenger/avenger_verg_avesta.vpcf", context)
	...
	PrecacheResource("particle", "particles/custom/ta/zabaniya_projectile.vpcf", context)
	...
	PrecacheResource("particle", "particles/items2_fx/rod_of_atos_debuff_ground.vpcf", context)
	PrecacheResource("soundfile", "soundevents/game_sounds_heroes/game_sounds_crystalmaiden.vsndevts", context)
	PrecacheResource("particle", "particles/custom/saber_alter/saber_alter_unleashed_ferocity.vpcf", context)
	...
	PrecacheResource("particle", "particles/saber_alter/saber_alter_excalibur_beam.vpcf", context)
	PrecacheResource("particle", "particles/saber_alter/saber_alter_excalibur_beam_pepeg.vpcf", context)
	PrecacheResource("particle", "particles/custom/saber_alter/saber_alter_excalibur_cast.vpcf", context)
	PrecacheResource("particle", "particles/custom/saber_alter/saber_alter_excalibur_overcharge.vpcf", context)
	PrecacheResource("particle", "particles/custom/saber_alter/saber_alter_excalibur_beam.vpcf", context)
	PrecacheResource("particle", "particles/custom/saber_alter/saber_alter_excalibur.vpcf", context)
	PrecacheResource("particle", "particles/custom/saber_alter/saber_alter_excalibur_beam_charge.vpcf", context)
	PrecacheResource("particle", "particles/custom/saber_alter/excalibur/shockwave.vpcf", context)
	PrecacheResource("particle", "particles/custom/saber_alter/excalibur/hit.vpcf", context)
	PrecacheResource("particle", "particles/econ/items/doom/doom_f2p_death_effect/doom_bringer_f2p_death_ring_d_black.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_enigma/enigma_blackhole_n.vpcf", context)
	PrecacheResource("particle", "particles/custom/rider/rider_bloodfort_andromeda_sphere.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_warlock/warlock_upheaval.vpcf", context)
	PrecacheResource("particle", "particles/custom/nursery_rhyme/plains_of_water.vpcf", context)
	...
	PrecacheResource("particle", "particles/custom/nursery_rhyme/doppelganger/doppelganger.vpcf", context)
	...
	PrecacheResource("particle", "particles/econ/generic/generic_projectile_linear_1/generic_projectile_linear_1.vpcf", context)
	...
	PrecacheResource("particle", "particles/units/heroes/hero_magnataur/magnataur_shockwave.vpcf", context)
	PrecacheResource("particle", "particles/custom/saber_alter/saber_alter_vortigern_line.vpcf", context)
	...
	PrecacheResource("particle", "particles/custom/lancer/lancer_culling_blade_kill.vpcf", context)
	PrecacheResource("particle", "particles/custom/lancer/lancer_heart_break_txt.vpcf", context)
	PrecacheResource("particle", "particles/custom/lancer/lancer_heart_break.vpcf", context)
	PrecacheResource("particle", "particles/items_fx/dagon.vpcf", context)
	PrecacheResource("particle", "particles/generic_gameplay/screen_blood_splatter.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_chen/chen_penitence_c.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_chen/chen_teleport_flash_sparks.vpcf", context)
	PrecacheResource("particle", "particles/custom/screen_scarlet_splash.vpcf", context)
	PrecacheResource("particle", "particles/custom/gilgamesh/enuma_elish.vpcf", context)
	PrecacheResource("particle", "particles/custom/gilgamesh/gilgamesh_enuma_elish_charge.vpcf", context)
	...
	PrecacheResource("particle", "particles/units/heroes/hero_keeper_of_the_light/keeper_cast01.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_lina/lina_spell_light_strike_array.vpcf", context)
	PrecacheResource("particle", "particles/custom/gawain/gawain_excalibur_galatine_orb.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_ember_spirit/ember_spirit_hit.vpcf", context)
	PrecacheResource("particle", "particles/custom/saber_excalibur_circle.vpcf", context)
	PrecacheResource("particle", "particles/custom/gawain/gawain_galetine_flametrail_parent.vpcf", context)
	PrecacheResource("particle", "particles/custom/gawain/gawain_galetine_explosion_parent.vpcf", context)
	...
	PrecacheResource("particle", "particles/units/heroes/hero_juggernaut/jugg_crit_blur_impact.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_ember_spirit/ember_spirit_hit_fire.vpcf", context)
	...
	PrecacheResource("particle", "particles/units/heroes/hero_omniknight/omniknight_guardian_angel_buff_j.vpcf", context)
	PrecacheResource("particle", "particles/custom/caster/sacrifice/caster_sacrifice_indicator.vpcf", context)
	...
	PrecacheResource("particle", "particles/units/heroes/hero_dazzle/dazzle_weave.vpcf", context)
	...
	PrecacheResource("particle", "particles/custom/berserker/reincarnation/regen_buff.vpcf", context)
	PrecacheResource("particle", "particles/custom/berserker/god_hand/stomp.vpcf", context)
	PrecacheResource("particle", "particles/items_fx/aegis_respawn.vpcf", context)
	PrecacheResource("particle", "particles/custom/berserker/god_hand/debuff.vpcf", context)
	...
	PrecacheResource("particle", "particles/econ/items/sniper/sniper_charlie/sniper_assassinate_impact_blood_charlie.vpcf", context)
	...
	PrecacheResource("particle", "particles/units/heroes/hero_doom_bringer/doom_bringer_lvl_death_bonus.vpcf", context)
	PrecacheResource("soundfile", "soundevents/game_sounds_heroes/game_sounds_legion_commander.vsndevts", context)
	PrecacheResource("soundfile", "soundevents/game_sounds_heroes/game_sounds_venomancer.vsndevts", context)
	PrecacheResource("particle", "particles/custom/astolfo/la_black_luna/la_black_luna_shockwave.vpcf", context)
	PrecacheResource("particle", "particles/custom/astolfo/astolfo_hippogriff_vanish.vpcf", context)
	...
	PrecacheResource("particle", "particles/custom/astolfo/astolfo_ground_mark_smile.vpcf", context)
	PrecacheResource("particle", "particles/custom/astolfo/hippogriff_ride/astolfo_hippogriff_ride_thunder.vpcf", context)
	PrecacheResource("particle", "particles/custom/astolfo/hippogriff_ride/astolfo_hippogriff_ride_aoe_indicator.vpcf", context)
	PrecacheResource("particle", "particles/custom/astolfo/hippogriff_ride/astolfo_hippogriff_rush_portal.vpcf", context)
	PrecacheResource("particle", "particles/custom/astolfo/astolfo_ground_mark_flex_10sec.vpcf", context)
	PrecacheResource("particle", "particles/econ/items/kunkka/divine_anchor/hero_kunkka_dafx_skills/kunkka_spell_torrent_bubbles_swirl_fxset.vpcf", context)
	PrecacheResource("particle", "particles/custom/astolfo/raid_hippogriff.vpcf", context)
	PrecacheResource("particle", "particles/custom/astolfo/astolfo_hippogriff_raid_flyer.vpcf", context)
	PrecacheResource("particle", "particles/custom/astolfo/astolfo_ground_mark_flex.vpcf", context)
	PrecacheResource("particle", "particles/custom/astolfo/hippogriff_raid/astolfo_hippogriff_raid_first_impact.vpcf", context)
	PrecacheResource("particle", "particles/custom/astolfo/hippogriff_raid/astolfo_hippogriff_raid_second_impact.vpcf", context)
	PrecacheResource("particle", "particles/custom/astolfo/hippogriff_raid/astolfo_hippogriff_raid_ascend.vpcf", context)
	PrecacheResource("particle", "particles/units/heroes/hero_dazzle/dazzle_weave_circle_ray.vpcf", context)
	PrecacheResource("particle", "particles/zlodemon/astolfo_jopa_shield.vpcf", context)
	-- [addon_doctor] авто-прекеш партиклей системных скриптов
	PrecacheResource("particle", "particles/combo_nanaya.vpcf", context)
	PrecacheResource("particle", "particles/nanaya_combo_21.vpcf", context)
	PrecacheResource("particle", "particles/nanaya_combo_212.vpcf", context)
	PrecacheResource("particle", "particles/nanaya_e1.vpcf", context)
	PrecacheResource("particle", "particles/nanaya_image_clon2.vpcf", context)
	PrecacheResource("particle", "particles/nanaya_image_clon21.vpcf", context)
	PrecacheResource("particle", "particles/nanaya_image_clon22.vpcf", context)
	PrecacheResource("particle", "particles/nanaya_image_clone1.vpcf", context)
	PrecacheResource("particle", "particles/nanaya_work_21.vpcf", context)
	PrecacheResource("particle", "particles/nanayatest.vpcf", context)
	PrecacheResource("particle", "particles/nanayatest1.vpcf", context)
	PrecacheResource("particle", "particles/screen_spla22_ark2.vpcf", context)
	PrecacheResource("particle", "particles/econ/items/antimage/antimage_weapon_basher_ti5_gold/am_basher_manaburn_impact_lightning_gold.vpcf", context)
	...
	PrecacheResource("particle", "particles/neutral_fx/prowler_shaman_stomp_debuff_glow.vpcf", context)
    ...
    PrecacheResource("soundfile", "soundevents/hero_cu_alter.vsndevts", context)
    ...
    PrecacheResource("soundfile", "soundevents/jia_qiu.vsndevts", context )
    ...
    PrecacheResource("soundfile", "soundevents/hero_okada.vsndevts", context)
    PrecacheResource("soundfile", "soundevents/hero_maou.vsndevts", context)
    PrecacheResource("soundfile", "soundevents/barbatos.vsndevts", context)
    PrecacheResource("soundfile", "soundevents/aemis_sounds.vsndevts", context)
    PrecacheResource("soundfile", "soundevents/hero_ozy.vsndevts", context)
    ...
    PrecacheResource("model", "models/diarmuid/diarmuid_no_dearg.vmdl", context)
    PrecacheResource("model", "models/zlodemon/salter_skin/sbr_alter.vmdl", context)
    PrecacheResource("model", "models/zlodemon/shiki_ryougi_skin/ryougi_skin.vmdl", context)
    PrecacheResource("model", "models/zlodemon/gojo.vmdl", context)
    PrecacheResource("model", "models/zlodemon/heracles_arbuz.vmdl", context)
    ...
    PrecacheResource("model", "models/zlodemon/baki/baki_shuwen.vmdl", context)  
    PrecacheResource("model", "models/zlodemon/yujiro/yujiro_kh.vmdl", context)  
    PrecacheResource("model", "models/barbatos/barbatos.vmdl", context)
    PrecacheResource("model", "models/zlodemon/matthias.vmdl", context)
    PrecacheResource("model", "models/nobu/nobu_skin_test.vmdl", context)
    ...
    PrecacheResource("model", "models/diarmuid/diar_skin.vmdl", context)
    PrecacheResource("model", "models/diarmuid/diar_skin_no_sword.vmdl", context)
    PrecacheResource("model", "models/zlodemon/shiki_ryougi_skin/ryougi_skin_2.vmdl", context)
    PrecacheResource("model", "models/lu_bu/jia_qiu.vmdl", context)
    PrecacheResource("model", "models/lu_bu/jia_qiu_staff.vmdl", context)
    ...
    PrecacheResource("particle",  "particles/fbt_incident_1.vpcf", context)
    PrecacheResource("particle",  "particles/fbt_incident_2.vpcf", context)
    PrecacheResource("particle",  "particles/fbt_incident_3.vpcf", context)
    PrecacheResource("particle",  "particles/fbt_incident_4.vpcf", context)
    PrecacheResource("particle",  "particles/fbt_incident_5.vpcf", context)
...
-- статистики (fate_version.lua, кнопка «Проштамповать версию»). Уезжает вместе
-- с матчем, чтобы статистика не смешивала балансы «до» и «после» правки.
  ...
  --  print("[BAREBONES] Hero spawned in game for first time -- " .. hero:GetUnitName())
    ...
    if hero:GetName() == "npc_dota_hero_doom_bringer" then 
        if not hero:HasModifier("modifier_god_hand_stock") then
            hero:AddNewModifier(hero, hero:FindAbilityByName("berserker_5th_god_hand"), "modifier_god_hand_stock", {}) 
        end
    end
...
function FateGameMode:OnPlayerLevelUp(keys)
  --  print ('[BAREBONES] OnPlayerLevelUp')
    ...
    -- Мастера могли не создаться / умереть: раньше обращение к мёртвому
    -- хендлу роняло OnPlayerLevelUp прямо посреди InitializeRound
    if not IsNotNull(hero.MasterUnit) or not IsNotNull(hero.MasterUnit2) then
        print("[Fate] WARNING: OnPlayerLevelUp - нет мастера у " .. hero:GetName())
        return
    end
...
function FateGameMode:ExecuteOrderFilterPepeg(filterTable)
    ...
    if orderType == DOTA_UNIT_ORDER_CAST_POSITION then
        if ability:GetName() == "astolfo_hippogriff_raid" then
            ...
            if (location - origin):Length2D() <= ability:GetCastRange(location, nil) then
