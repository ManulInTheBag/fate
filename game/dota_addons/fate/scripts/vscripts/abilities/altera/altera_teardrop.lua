...
function altera_teardrop_release:OnSpellStart()
	...
	Timers:CreateTimer(2.0, function()
		...
		ParticleManager:SetParticleControl(fxIndexjopa, 0, target)
		ParticleManager:SetParticleControl(fxIndexjopa, 1, Vector(1,1,1))
		ParticleManager:SetParticleControl(fxIndexjopa, 2, Vector(beam_radius,2,0))
