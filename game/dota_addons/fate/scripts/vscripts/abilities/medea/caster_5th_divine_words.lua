...
-- Бонус от атрибута Improve Hecatic Graea (caster_5th_attribute_improve_hecatic_graea).
-- Раньше жил в глобале ATTRIBUTE_HG_INT_MULTIPLIER из caster_ability.lua: тот файл
-- грузится только вместе с datadriven-способностью с таким ScriptFile, поэтому
-- множитель мог прийти nil (краш) и был общим на всех игроков сразу.
...
OnDWStart = function(keys)
	...
	if caster.IsHGImproved then damage = damage + caster:GetIntellect() * HG_INT_MULTIPLIER end
