...
function artoria_excalibur:OnSpellStart()
	...
	Timers:CreateTimer(delay, function()
		if caster:IsAlive() then
			...
			ParticleManager:SetParticleControl(excalFxIndex, 3, Vector(width,0,0)) 
			ParticleManager:SetParticleControl(excalFxIndex, 9, Vector(0.8,0,0)) 
			ParticleManager:SetParticleControl(excalFxIndex, 63, Vector(1,1,0)) 
			ParticleManager:SetParticleControl(excalFxIndex, 15, caster:GetAbsOrigin() )
   			ParticleManager:SetParticleControl(excalFxIndex, 16, caster:GetAbsOrigin() + pepega_vec*(range + 250)) 
			...
			Timers:CreateTimer(0.1, function()
				...
				ParticleManager:SetParticleControl(excalpepegFxIndex, 63, Vector(1,1,0)) 
