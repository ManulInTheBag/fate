...
LinkLuaModifier("modifier_murderous_instinct_bash_checker","abilities/angra_mainyu/modifiers/modifier_murderous_instinct_bash_checker", LUA_MODIFIER_MOTION_NONE)
...
function OnBashSuccess(keys)
	...
	if not caster:HasModifier("modifier_murderous_instinct_bash_checker") then
		caster:AddNewModifier(caster, target, "modifier_murderous_instinct_bash_checker", {duration = 2}) 
