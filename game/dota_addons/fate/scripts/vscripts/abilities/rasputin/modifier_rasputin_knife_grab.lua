...
function modifier_rasputin_knife_grab:DealSlamDamage()
    ...
    -- тело вынесено в RasputinGrabSlam (rasputin_gesture.lua): тот же удар
    -- нужен и когда цель успела телепортироваться и её не тащат
    RasputinGrabSlam(self.parent, self.victim, self.ability)
