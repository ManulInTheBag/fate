...
function okita_zekken:StartZekken(target)
    ...
    ParticleManager:SetParticleShouldCheckFoW(circleIndex, false)
    AddFOWViewer(2, caster:GetAbsOrigin(), radius, 3.5, false)
	AddFOWViewer(3, caster:GetAbsOrigin(), radius, 3.5, false)
    --EmitGlobalSound("Okita.Precombo")
