...
var LoadingScreen = (function () {
    function LoadingScreen(panel) {
        ...
        this.backgrounds = 44; // Number of backgrounds. Change this to add more or less.
        this.tips = 9; // Number of tips.
        ...
        GameEvents.Subscribe("player_reconnected", function (data) { _this.OnPlayerReconnect(data); });
    }
    ...
    LoadingScreen.prototype.OnPlayerReconnect = function (data) {
        if (Game.GameStateIsAfter(DOTA_GameState.DOTA_GAMERULES_STATE_WAIT_FOR_PLAYERS_TO_LOAD)) {
            $("#BackgroundLogo").SetHasClass("Hidden", true);
            $("#Tip").SetHasClass("Hidden", true);
