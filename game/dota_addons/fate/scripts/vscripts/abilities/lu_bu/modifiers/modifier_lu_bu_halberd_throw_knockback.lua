modifier_lu_bu_halberd_throw_knockback = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_lu_bu_halberd_throw_knockback:IsHidden()
	return true
end

function modifier_lu_bu_halberd_throw_knockback:IsPurgable()
	return false
end

function modifier_lu_bu_halberd_throw_knockback:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end
--------------------------------------------------------------------------------
-- Initializations
function modifier_lu_bu_halberd_throw_knockback:OnCreated( kv )
	if IsServer() then
...
function modifier_lu_bu_halberd_throw_knockback:OnRefresh( kv )
	if not IsServer() then return end
end

function modifier_lu_bu_halberd_throw_knockback:OnDestroy( kv )
	if not IsServer() then return end
...
--------------------------------------------------------------------------------
-- Setter
function modifier_lu_bu_halberd_throw_knockback:SetEndCallback( func ) 
	self.EndCallback = func
end

--------------------------------------------------------------------------------
-- Modifier Effects
function modifier_lu_bu_halberd_throw_knockback:DeclareFunctions()
	local funcs = {
...
function modifier_lu_bu_halberd_throw_knockback:GetOverrideAnimation( params )
	if self.anim==1 then
...
--------------------------------------------------------------------------------
-- Status Effects
function modifier_lu_bu_halberd_throw_knockback:CheckState()
	local state = {
...
--------------------------------------------------------------------------------
-- Motion effects
function modifier_lu_bu_halberd_throw_knockback:UpdateHorizontalMotion( me, dt )
...
function modifier_lu_bu_halberd_throw_knockback:OnHorizontalMotionInterrupted()
	if IsServer() then
...
function modifier_lu_bu_halberd_throw_knockback:UpdateVerticalMotion( me, dt )
	-- set time
...
function modifier_lu_bu_halberd_throw_knockback:OnVerticalMotionInterrupted()
	if IsServer() then
		self.interrupted = true
		self:Destroy()
	end
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_lu_bu_halberd_throw_knockback:GetEffectName()
	if not IsServer() then return end
	if self.stun then
...
function modifier_lu_bu_halberd_throw_knockback:GetEffectAttachType()
	if not IsServer() then return end
