...
require('modifiers/cc_modifiers') -- generic CC/state modifiers (ex-datadriven container)
...
function Precache( context )
    ...
    -- gilles DD->lua (тентакли/интеграция/комбо + живой contract-lua)
    ...
    PrecacheResource("particle", "particles/custom/gilles/abyssal_contract_smoke.vpcf", context)
    PrecacheResource("particle", "particles/custom/gilles/abyssal_contract_sigil.vpcf", context)
    PrecacheResource("particle", "particles/custom/gilles/abyssal_contract_pulse.vpcf", context)
    PrecacheResource("particle", "particles/custom/gilles/abyssal_contract_tentacles.vpcf", context)
