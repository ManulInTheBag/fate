...
function karna_spears_barrage:OnSpellStart()
	...
	if caster.IndraAttribute then
		damage = damage + (caster.IndraAttribute and 0.5 * caster:GetIntellect() or 0)
	end
	...
	local fx_jopa_2  = ParticleManager:CreateParticle("particles/karna/karna_spears_radiusvpcf.vpcf", PATTACH_WORLDORIGIN , nil )
	...
	ParticleManager:SetParticleShouldCheckFoW(fx_jopa_2, false)
