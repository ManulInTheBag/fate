...
function kuro_clairvoyance:OnSpellStart()
	...
	local circleFxIndex = ParticleManager:CreateParticle( "particles/custom/archer/archer_clairvoyance_circle.vpcf", PATTACH_CUSTOMORIGIN, caster.visiondummy )
	ParticleManager:SetParticleControl( circleFxIndex, 0, caster.visiondummy:GetAbsOrigin() )
	...
	local dustFxIndex = ParticleManager:CreateParticle( "particles/custom/archer/archer_clairvoyance_dust.vpcf", PATTACH_CUSTOMORIGIN, caster.visiondummy )
