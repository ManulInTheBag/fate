modifier_scathach_gait_one_knockback = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_scathach_gait_one_knockback:IsHidden()
	return true
end

function modifier_scathach_gait_one_knockback:IsPurgable()
	return false
end

function modifier_scathach_gait_one_knockback:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end
--------------------------------------------------------------------------------
-- Initializations
function modifier_scathach_gait_one_knockback:OnCreated( kv )
	if IsServer() then
...
function modifier_scathach_gait_one_knockback:OnRefresh( kv )
	if not IsServer() then return end
end

function modifier_scathach_gait_one_knockback:OnDestroy( kv )
	if not IsServer() then return end
...
--------------------------------------------------------------------------------
-- Setter
function modifier_scathach_gait_one_knockback:SetEndCallback( func ) 
	self.EndCallback = func
end

--------------------------------------------------------------------------------
-- Modifier Effects
function modifier_scathach_gait_one_knockback:DeclareFunctions()
	local funcs = {
...
function modifier_scathach_gait_one_knockback:GetOverrideAnimation( params )
	if self.anim==1 then
...
--------------------------------------------------------------------------------
-- Status Effects
function modifier_scathach_gait_one_knockback:CheckState()
	local state = {
...
--------------------------------------------------------------------------------
-- Motion effects
function modifier_scathach_gait_one_knockback:UpdateHorizontalMotion( me, dt )
...
function modifier_scathach_gait_one_knockback:OnHorizontalMotionInterrupted()
	if IsServer() then
...
function modifier_scathach_gait_one_knockback:UpdateVerticalMotion( me, dt )
	-- set time
...
function modifier_scathach_gait_one_knockback:OnVerticalMotionInterrupted()
	if IsServer() then
		self.interrupted = true
		self:Destroy()
	end
