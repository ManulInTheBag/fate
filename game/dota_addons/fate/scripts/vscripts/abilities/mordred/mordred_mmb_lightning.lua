...
function mordred_mmb_lightning:OnSpellStart()
	...
	Timers:CreateTimer("mordred_rush", {
		...
		ParticleManager:SetParticleControl(fxIndexjopa, 1, Vector(1,0.01,0.01))
		ParticleManager:SetParticleControl(fxIndexjopa, 2, Vector(self:GetSpecialValueFor("blast_radius"),4,0))
	...
	caster:OnPreBounce(function(unit, normal) -- stop the pushback when unit hits wall
		...
		ParticleManager:SetParticleControl(fxIndexjopa, 0, caster:GetAbsOrigin())
		ParticleManager:SetParticleControl(fxIndexjopa, 1, Vector(1,0.01,0.01))
		ParticleManager:SetParticleControl(fxIndexjopa, 2, Vector(self:GetSpecialValueFor("blast_radius"),5,0))
		ParticleManager:ReleaseParticleIndex(fxIndexjopa)
