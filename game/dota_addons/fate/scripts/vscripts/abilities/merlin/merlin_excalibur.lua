...
function merlin_excalibur:OnSpellStart()
    ...
    AddFOWViewer(2,caster:GetAbsOrigin() + Vector(0, 0, 266), 10, 1, false)
    AddFOWViewer(3,caster:GetAbsOrigin() + Vector(0, 0, 266), 10, 1, false)
    ...
    EmitSoundOn("merlin_excalibur", caster)
