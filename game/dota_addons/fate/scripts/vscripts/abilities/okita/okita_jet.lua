...
function modifier_jet_kappa:OnIntervalThink()
	...
	if true then
		...
		local damage = self:GetAbility():GetSpecialValueFor("base_damage")+(self.parent.IsKikuIchimonjiAcquired and self.parent:GetAgility()*2.5 or 0) --self.parent:FindAbilityByName("okita_sandanzuki"):GetSpecialValueFor("base_damage")
		for i = 1,#enemy do
